...
summary: 'Self-hosted orchestration daemon with trust-gated execution (L0-L4), policy engine, and audit logging. 27 agents (18 mature) managing live projects.'
description: 'Autonomous agent orchestration daemon with trust-layered L0-L4 execution, YAML policy engine, budget guards, and audit logging. 27 agents manage code review, deployments, monitoring, and client reports across 4 production projects.'
category: platform
...
tech:
  ...
  - GitHub Actions
outcomes:
  - '27 agents built, 18 operating at mature trust levels (L2+)'
