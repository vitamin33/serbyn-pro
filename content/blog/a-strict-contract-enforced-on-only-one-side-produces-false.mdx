...
description: "A strict contract enforced on only one side produces false rejections as reliably as a loose contract produces false acceptances. A field report from my agent fleet."
date: '2026-06-22'
keywords:
...
In my fleet, fixing Mechanism 1 — the refusal was *legible* — progress notes showed a clean trace. The agent's reasoning was sound. The gate's rejection was technically valid. Both were right. The contract was broken.
