...
description: "How fail-closed design, headless execution seams, and converting incidents to fixtures stop AI agents from lying about success. Field report from a production fleet."
date: '2026-06-22'
keywords:
...
Six times in production, an agent reported success when nothing had actually happened. The pipeline didn't catch them by luck — it caught them because of three structural decisions that compound on each other.
